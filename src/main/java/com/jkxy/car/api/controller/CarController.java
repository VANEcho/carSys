...
public class CarController {
    ...
    public JSONResult buyCar(BuyCar buyCar){
        return carService.buyCarById(buyCar);
    }

    /**
     * 模糊查询
     */
    @GetMapping("fuzzyQueryByCarName")
    public JSONResult fuzzyQueryByCarName( FuzzyQuery fuzzyQuery){
        List<Car> cars = carService.fuzzyQueryByCarName(fuzzyQuery);
        return JSONResult.ok(cars);
    }
}
